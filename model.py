...
class Brand(db.Model):
     ...
     def __repr__(self):
        ...
        return f'brand_id = {self.brand_id}, name = {self.name}, founded = {self.founded}, headquarters = {self.headquarters}'
...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return f'model_id = {self.model_id}, year = {self.year}, brand_id = {self.brand_id}, name = {self.name}, brand = {self.brand}'
